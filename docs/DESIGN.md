...
diff engine, audit bundles, rules R01–R39 (less the Pro rules
...
- Anomaly rules R01–R10 and R14–R39 (all rules except the Pro examples
  R11–R13), covering host state, security signals, the v0.5
  filesystem/firewall anomalies, and v0.6 container start/stop/privileged
